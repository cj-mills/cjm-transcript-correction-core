...
from cjm_transcript_correction_core.spine import parse_mark_input, resolve_mark_class_token, SpineView, plan_boundary_shift
...
def test_match_sources_selector_arms():
    ...
    from cjm_transcript_correction_core.spine import match_sources
...
def test_load_source_slice_decodes_original_media(tmp_path):
    ...
    from cjm_transcript_correction_core.spine import load_source_slice
...
def test_plan_time_nudge_welds_and_refusals():
    ...
    from cjm_transcript_correction_core.spine import plan_time_nudge
...
def test_plan_chunk_insert_gap_weld_tail_refusals():
    ...
    from cjm_transcript_correction_core.spine import plan_chunk_insert
...
def test_parse_entity_input_provisional():
    ...
    from cjm_transcript_correction_core.spine import parse_entity_input
...
def test_plan_chunk_split_caret_seed_and_anchors():
    ...
    from cjm_transcript_correction_core.spine import plan_chunk_split
...
def test_plan_gate_grammar():
    ...
    from cjm_transcript_correction_core.spine import plan_gate
...
def test_snap_word_span_direct_fuzzy_and_estimated():
    ...
    from cjm_transcript_correction_core.spine import segment_word_tokens, snap_word_span
...
def test_spineview_overlay_bookkeeping():
    ...
    from cjm_transcript_correction_core.spine import SpineView
    view = SpineView.__new__(SpineView)
    view._overlays = []
...
def test_neighbor_word_bound_overshoot_guard_data():
    ...
    from cjm_transcript_correction_core.spine import neighbor_word_bound, segment_word_tokens
    text = "uh in your"
